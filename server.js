...
const propertyAddRequestRoutes = require('./routes/propertyAddRequestRoutes');
const { getResidenceOptions } = require('./controllers/registrationController');
...
app.use('/api/property-add-requests', propertyAddRequestRoutes);
